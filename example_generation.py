...
# define the file names of the examples
file_names = ['RL-002.jpg','RL-010.jpg','RL-032.jpg','RL-049.jpg',
    'RL-094.jpg','RL-178.jpg','RL-186.jpg','RL-259.jpg']
...
for i in range(len(file_names)):
    ...
    image.save(examples_path + file_names[i])